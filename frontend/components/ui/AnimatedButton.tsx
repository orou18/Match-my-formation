...
const AnimatedButton = forwardRef<HTMLButtonElement, AnimatedButtonProps>(
  (
    ...
    const variants = {
      primary:
        "bg-gradient-to-r from-primary to-primary-hover text-white hover:shadow-lg hover:shadow-primary/25 focus:ring-primary",
      secondary:
        "bg-gray-900 text-white hover:bg-gray-800 hover:shadow-lg focus:ring-gray-900",
      outline:
