    ...
    >
      ...
      >
        ...
        <div className="absolute top-5 left-5 flex gap-2">
          <span
            className={`px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-tighter shadow-2xl backdrop-blur-md 
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        <p className="text-sm text-white/40 leading-relaxed mb-6 flex-grow line-clamp-2">
          {course.description ||
            "Maîtrisez les codes du secteur et devenez un acteur clé de l'industrie touristique."}
        </p>
