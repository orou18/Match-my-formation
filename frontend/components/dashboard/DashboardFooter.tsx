        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 md:gap-4">
          ...
          <div className="flex gap-3">
             {["facebook", "linkedIn"].map((social) => (
                <div key={social} className="w-8 h-8 bg-gray-50 rounded-xl flex items-center justify-center cursor-pointer hover:bg-primary/10 group transition-all">
                  <Image src={`/${social}.png`} alt={social} width={14} height={14} className="opacity-40 group-hover:opacity-100 transition-opacity" />
                </div>
             ))}
          </div>
