  ...
  return (
    ...
    >
      <div className="flex gap-4 items-start relative z-10">
        <div
          className={`p-3 rounded-xl ${isObtained ? "bg-primary text-white shadow-lg shadow-primary/30" : "bg-gray-100 text-gray-400"}`}
        >
          <Award size={24} />
        </div>
        <div className="flex-1">
          <h4 className="font-bold text-[#002B24] leading-tight mb-1">
            {title}
          </h4>
