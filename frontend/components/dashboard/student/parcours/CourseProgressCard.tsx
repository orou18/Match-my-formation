...
export default function CourseProgressCard({ title, module, progress, image }: any) {
  return (
    <motion.div 
      whileHover={{ y: -5 }}
    ...
    >
      ...
      <div className="flex-1 w-full">
        <div className="flex justify-between items-start mb-2">
          <h3 className="font-bold text-[#002B24] text-lg leading-tight">{title}</h3>
          <span className="text-[10px] font-black bg-gray-100 px-2 py-1 rounded text-gray-500 uppercase tracking-tighter">En cours</span>
        </div>
