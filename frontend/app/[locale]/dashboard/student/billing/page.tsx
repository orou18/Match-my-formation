    ...
    <div className="min-h-screen bg-[#F8FAFB] pb-20">
      ...
      >
        <div className="space-y-2">
          <h1 className="text-3xl font-black text-[#002B24]">Abonnement & Facturation</h1>
          <p className="text-gray-500 font-medium">Gérez votre offre et téléchargez vos factures en toute sécurité.</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="space-y-6">
            <div className="bg-white p-8 rounded-[2rem] border border-gray-100 shadow-sm">
              <h4 className="font-black text-[#002B24] mb-4">Besoin de changement ?</h4>
              <p className="text-sm text-gray-500 mb-6">Vous pouvez mettre à jour votre plan ou annuler à tout moment.</p>
