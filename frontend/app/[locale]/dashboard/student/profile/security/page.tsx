...
export default function SecurityPage() {
  ...
  const cardStyle =
    "bg-white border border-gray-100 rounded-[2rem] p-8 shadow-sm hover:shadow-md transition-all";
      ...
      <div className={cardStyle}>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="font-bold text-lg text-[#002B24]">
        ...
        >
          ...
          >
            ...
            {!showVerificationCode ? (
              ...
              <div className="space-y-6">
                <p className="text-gray-600">
                  Entrez le code à 6 chiffres envoyé par{" "}
                  {twoFactorForm.method === "email" ? "email" : "SMS"}
                </p>
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    disabled={
                      loading || twoFactorForm.verificationCode.length !== 6
                    }
                    className="flex-1 px-6 py-3 bg-primary text-white rounded-2xl font-semibold hover:bg-primary/90 transition-colors disabled:opacity-50"
                  >
        ...
        <div className={cardStyle}>
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">
                {securitySettings.activeSessions} appareils connectés
              </p>
            </div>
          </div>
