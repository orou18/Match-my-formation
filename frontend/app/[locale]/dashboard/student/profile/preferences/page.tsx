    ...
    <div className="space-y-8">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h3 className="font-bold text-lg text-primary dark:text-primary">
              {localT("preferences.notifications", "Notifications")}
            </h3>
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-medium text-primary dark:text-primary">
                  {localT("preferences.newsletter", "Newsletter")}
                </p>
                <p className="text-sm text-secondary dark:text-secondary">
                  {localT(
                    "preferences.newsletter_desc",
      ...
      <div className={cardStyle}>
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h3 className="font-bold text-lg text-primary dark:text-primary">
              {localT("preferences.appearance", "Apparence")}
            </h3>
            <p className="text-sm text-secondary dark:text-secondary">
              {localT(
                "preferences.appearance_desc",
        ...
        <div className="space-y-6">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-3">
              {localT("preferences.theme", "Thème")}
            </label>
            <div className="grid grid-cols-2 gap-4">
              ...
              >
                ...
                <p className="font-medium">
                  {localT("preferences.light_theme", "Clair")}
                </p>
              </button>
              <button
              ...
              >
                ...
                <p className="font-medium">
                  {localT("preferences.dark_theme", "Sombre")}
                </p>
              </button>
            </div>
          </div>
      ...
      <div className={cardStyle}>
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h3 className="font-bold text-lg text-primary dark:text-primary">
              {localT("preferences.language_region", "Langue et région")}
            </h3>
            <p className="text-sm text-secondary dark:text-secondary">
              {localT(
                "preferences.language_region_desc",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
              {localT("preferences.language", "Langue")}
            </label>
            <select
              value={language}
              onChange={(e) =>
                handleLanguageChange(e.target.value as "fr" | "en" | "es")
              }
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
              {localT("preferences.timezone", "Fuseau horaire")}
            </label>
            <select
      ...
      <div className="flex justify-end">
        ...
        >
          {loading
            ? localT("common.saving", "Sauvegarde...")
            : localT(
