  ...
  const handleSavePreferences = async () => {
    try {
      ...
      if (response.ok) {
        ...
        showMessage(
          t("preferences.save_success", "Préférences sauvegardées avec succès"),
          "success"
        );
      } else {
      ...
      showMessage(
        t("preferences.save_success", "Préférences sauvegardées localement"),
        "success"
      );
    } finally {
      setLoading(false);
    ...
    <div className="space-y-8">
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-medium text-primary">
                  {t("preferences.push_notifications", "Notifications push")}
                </p>
                <p className="text-sm text-secondary">
                  {t(
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-medium text-primary">
                  {t("preferences.newsletter", "Newsletter")}
                </p>
                <p className="text-sm text-secondary">
                  {t("preferences.newsletter_desc", "Actualités et nouveautés")}
                </p>
              </div>
            </div>
            <button
      ...
      <div className={cardStyle}>
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h3 className="font-bold text-lg text-primary">
              {t("preferences.appearance", "Apparence")}
            </h3>
            <p className="text-sm text-secondary">
              {t("preferences.appearance_desc", "Personnalisez l'interface")}
            </p>
          </div>
        </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              >
                ...
                <p className="font-medium">
                  {t("preferences.light_theme", "Clair")}
                </p>
              </button>
              <button
              ...
              >
                ...
                <p className="font-medium">
                  {t("preferences.dark_theme", "Sombre")}
                </p>
              </button>
            </div>
          </div>
      ...
      <div className={cardStyle}>
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            <h3 className="font-bold text-lg text-primary">
              {t("preferences.language_region", "Langue et région")}
            </h3>
            <p className="text-sm text-secondary">
              {t(
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
              {t("preferences.timezone", "Fuseau horaire")}
            </label>
            <select
      ...
      <div className="flex justify-end">
        ...
        >
          {loading
            ...
            : t("preferences.save_preferences", "Enregistrer les préférences")}
        </button>
      </div>
    </div>
  );
