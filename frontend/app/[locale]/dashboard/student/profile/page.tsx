  ...
  const handleSave = async () => {
    try {
      ...
      if (response.ok) {
        ...
        setSaveMessage({ type: 'error', message: 'Erreur lors de la mise à jour du profil' });
      }
    } catch (error) {
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      ...
      >
        ...
        <div className="bg-white rounded-2xl shadow-sm p-6 mb-6 flex justify-between items-center">
          <h1 className="text-2xl font-bold text-[#002B24]">Mon Profil</h1>
          {!isEditing ? (
            <button
              onClick={handleEdit}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-sm p-6">
              <h2 className="text-xl font-bold text-[#002B24] mb-6 flex items-center gap-3">
            ...
            <div className="bg-white rounded-2xl shadow-sm p-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                <div className="text-center">
                  <div className="text-3xl font-bold text-[#004D40]">{currentUser.coursesCompleted}</div>
                  <div className="text-sm text-gray-600">Cours terminés</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-[#004D40]">{currentUser.certificates}</div>
                  <div className="text-sm text-gray-600">Certificats</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-[#004D40]">{currentUser.averageRating}</div>
                  <div className="text-sm text-gray-600">Note moyenne</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-[#004D40]">{currentUser.completionRate}%</div>
          ...
          <div className="space-y-6">
            {/* Avatar */}
            <div className="bg-white rounded-2xl shadow-sm p-6">
              <h2 className="text-xl font-bold text-[#002B24] mb-6">Photo de profil</h2>
            ...
            <div className="bg-white rounded-2xl shadow-sm p-6">
              <h2 className="text-xl font-bold text-[#002B24] mb-6">Niveau</h2>
              <div className="text-center mb-4">
                <div className="text-4xl font-bold text-[#004D40] mb-2">Niveau {currentUser.level}</div>
            ...
            <div className="bg-gradient-to-r from-[#004D40] to-[#00695C] rounded-2xl shadow-sm p-8 text-white w-full">
              ...
              <div className="text-center mb-6">
                <div className="text-3xl font-bold mb-2">{currentUser.subscription}</div>
