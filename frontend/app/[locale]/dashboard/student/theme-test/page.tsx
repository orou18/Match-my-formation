...
export default function ThemeTestPage() {
  ...
  useEffect(() => {
    ...
    addLog(`🎨 document.documentElement.classList: ${document.documentElement.classList.toString()}`);
    addLog(`🌈 document.documentElement.style.colorScheme: ${document.documentElement.style.colorScheme || 'non défini'}`);
  }, []);
      ...
      <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="font-medium text-gray-900 dark:text-white">Thème React</span>
              </div>
            ...
            <div className="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-4">
              <div className="flex items-center gap-2 mb-2">
                <span className="font-medium text-gray-900 dark:text-white">HTML Class</span>
              </div>
            ...
            <div className="bg-orange-50 dark:bg-orange-900/20 rounded-lg p-4">
              <div className="flex items-center gap-2 mb-2">
                <span className="font-medium text-gray-900 dark:text-white">Color Scheme</span>
              </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-3">Forcer le thème</h3>
            ...
            <div>
              <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-3">Nettoyage</h3>
              <button
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
          ...
          <div className="bg-gray-900 dark:bg-gray-100 rounded-lg p-4 max-h-64 overflow-y-auto font-mono text-sm">
            {logs.length === 0 ? (
              <p className="text-gray-400 dark:text-gray-600">Aucun log pour le moment...</p>
            ) : (
              logs.map((log, index) => (
                <div key={index} className="text-green-400 dark:text-green-600 mb-1">
                  {log}
                </div>
              ))
            )}
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-2xl p-6">
          ...
          <ul className="space-y-2 text-blue-800 dark:text-blue-200">
            <li>• <strong>Forcer LIGHT</strong> : Applique immédiatement le thème clair et nettoie le localStorage</li>
            <li>• <strong>Forcer DARK</strong> : Applique immédiatement le thème sombre</li>
            <li>• <strong>Tout nettoyer</strong> : Supprime toutes les données de thème et recharge la page</li>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border border-gray-200 dark:border-gray-700">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              <span className="text-purple-600 dark:text-purple-400 font-medium">🎨 Test Theme</span>
            </a>
          </div>
        </div>
      </div>
