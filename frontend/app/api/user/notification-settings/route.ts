...
export async function PUT(request: NextRequest) {
  try {
    ...
    // Validation basique
    const allowedFields = ['courseAlerts', 'marketingEmails', 'directMessages', 'systemAnnouncements', 'achievementAlerts', 'weeklyDigest'];
    ...
    console.log('Mise à jour des paramètres de notification:', filteredSettings);
