...
export const PREMIUM_COURSES = [
  {
    ...
    description:
      "Devenez un expert du management dans le secteur du luxe avec cette formation complète.",
    long_description:
      "Cette formation exclusive vous plongera au cœur de l'industrie du luxe, où vous maîtriserez les techniques de management les plus sophistiquées. De la gestion des équipes à l'expérience client, en passant par la stratégie de marque et le digital, vous développerez une expertise à 360° du secteur premium.",
    ...
    modules: [
      {
        ...
        lessons: [
          {
            title: "Introduction au secteur du luxe",
            duration: "45 min",
            type: "video" as const,
          },
          {
          ...
          {
            title: "Étude de cas: Ritz Carlton",
            duration: "30 min",
      ...
      },
      {
        ...
        lessons: [
          {
            title: "Positionnement et differentiation",
            duration: "55 min",
            type: "video" as const,
          },
          {
            title: "Storytelling de luxe",
            duration: "40 min",
            type: "video" as const,
          },
          {
            title: "Exercice: Créer votre marque",
            duration: "45 min",
      ...
      },
      {
        ...
        lessons: [
          {
            title: "Recrutement dans le luxe",
            duration: "50 min",
            type: "video" as const,
          },
          {
      ...
      },
      {
        ...
        lessons: [
          {
            title: "Les standards du service premium",
            duration: "55 min",
            type: "video" as const,
          },
          {
            title: "Gestion des situations complexes",
            duration: "40 min",
            type: "video" as const,
          },
          {
  ...
  },
  {
    ...
    description:
      "Maîtrisez les enjeux de l'écotourisme et développez des projets touristiques durables.",
    long_description:
      "Cette formation vous forme aux meilleures pratiques de l'écotourisme, de la conception de projets durables à la gestion environnementale. Vous apprendrez à créer des expériences touristiques qui respectent l'environnement tout en étant économiquement viables.",
    ...
    modules: [
      ...
      },
      {
        ...
        lessons: [
          ...
          {
            title: "Design d'expériences éco-responsables",
            duration: "45 min",
            type: "video" as const,
          },
          {
            title: "Exercice: Plan de durabilité",
            duration: "60 min",
            type: "exercise" as const,
          },
        ],
      },
      {
        ...
        lessons: [
          ...
          {
            title: "Economie circulaire en tourisme",
            duration: "45 min",
            type: "video" as const,
          },
        ],
  ...
  },
  {
    ...
    description:
      "Maîtrisez les stratégies digitales pour transformer votre activité touristique.",
    long_description:
      "Cette formation complète vous enseigne toutes les techniques de marketing digital appliquées au tourisme. De la création de contenu virale à l'optimisation des réservations, en passant par l'analyse de données et l'IA, vous deviendrez un expert du marketing touristique digital.",
    ...
    modules: [
      {
        ...
        lessons: [
          ...
          {
            title: "Exercice: Plan de contenu",
            duration: "40 min",
            type: "exercise" as const,
          },
        ],
      },
      {
        ...
        lessons: [
          {
            title: "Instagram et TikTok pour le tourisme",
            duration: "50 min",
            type: "video" as const,
          },
          {
      ...
      },
      {
        ...
        lessons: [
          {
            title: "Optimisation pour les moteurs",
            duration: "55 min",
            type: "video" as const,
          },
          {
            title: "Google Ads pour le tourisme",
            duration: "45 min",
            type: "video" as const,
          },
          {
      ...
      },
      {
        ...
        lessons: [
          ...
          {
            title: "IA dans le marketing touristique",
            duration: "45 min",
            type: "video" as const,
          },
          {
            title: "Prédictions et tendances",
            duration: "40 min",
            type: "video" as const,
          },
        ],
  ...
  },
  {
    ...
    description:
      "Optimisez vos revenus avec les techniques les plus avancées du revenue management.",
    long_description:
      "Devenez un expert en optimisation des revenus avec cette formation spécialisée. Vous maîtriserez les techniques de pricing dynamique, la gestion des canaux de distribution, l'analyse prédictive et les stratégies de maximisation des revenus dans l'hôtellerie et le tourisme.",
    ...
    modules: [
      {
        ...
        lessons: [
          ...
          {
            title: "Étude de cas: Pricing strategy",
            duration: "40 min",
            type: "reading" as const,
          },
        ],
      },
      {
        ...
        lessons: [
          ...
          {
            title: "Algorithmes et automatisation",
            duration: "60 min",
            type: "video" as const,
          },
          {
            title: "Exercice: Optimisation des prix",
            duration: "45 min",
            type: "exercise" as const,
          },
        ],
      },
      {
        ...
        lessons: [
          {
            title: "Gestion des OTA",
            duration: "50 min",
            type: "video" as const,
          },
          {
            title: "Direct vs indirect booking",
            duration: "40 min",
            type: "video" as const,
          },
          {
