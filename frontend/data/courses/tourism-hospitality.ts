...
export const luxuryHotelManagement: Course = {
  ...
  description: "Maîtrisez les stratégies de gestion hôtelière haut de gamme et développez une expertise dans l'industrie du luxe. Ce cours complet vous formera aux meilleures pratiques mondiales en matière d'opérations hôtelières, de service client et de management stratégique.",
  ...
  instructor: {
    ...
    expertise: ["Management Hôtelier", "Service Client", "Stratégie de Luxe", "Opérations"]
  },
  modules: [
    {
      id: "module-1",
      title: "Introduction au Management Hôtelier de Luxe",
      description: "Découvrez les fondamentaux du management dans l'industrie hôtelière de luxe",
      duration: "1h30",
      lessons: [
        {
          id: "lesson-1-1",
    ...
    },
    {
      ...
      description: "Maîtrisez les opérations quotidiennes et l'excellence du service",
      duration: "2h",
      lessons: [
        {
          id: "lesson-2-1",
...
export const ecotourismSustainable: Course = {
  ...
  description: "Initiatives éco-responsables dans le tourisme africain. Apprenez à concevoir et gérer des projets touristiques durables qui respectent l'environnement et les communautés locales tout en étant économiquement viables.",
  ...
  instructor: {
    ...
    expertise: ["Écotourisme", "Développement Durable", "Tourisme Communautaire", "Conservation"]
  },
  modules: [
    {
      id: "module-1",
      ...
      lessons: [
        {
          ...
          description: "Les concepts fondamentaux et les différences avec le tourisme traditionnel",
          duration: "30 min",
          type: "video",
          order: 1
        },
        {
          ...
          description: "L'importance de la biodiversité dans les projets écotouristiques",
          duration: "35 min",
          type: "video",
          order: 2
        },
  ...
  tags: ["Écotourisme", "Développement Durable", "Afrique", "Conservation", "Communautaire"]
};
...
export const digitalCustomerJourney: Course = {
  ...
  description: "IA et Data pour optimiser l'expérience client. Transformez votre approche client avec les technologies digitales, l'intelligence artificielle et l'analyse de données pour créer des expériences personnalisées et mémorables.",
  ...
  instructor: {
    ...
    expertise: ["IA", "Data Analytics", "Customer Experience", "Digital Transformation"]
  },
  modules: [
    {
      id: "module-1",
      title: "Fondamentaux du Digital et de l'IA",
      description: "Introduction aux technologies digitales et à l'IA appliquées au tourisme",
      duration: "2h",
      lessons: [
        {
          id: "lesson-1-1",
          title: "Transformation Digitale du Secteur Touristique",
          description: "L'impact du digital sur les modèles d'affaires touristiques",
          duration: "40 min",
          type: "video",
          order: 1
        },
        ...
        },
        {
          ...
          description: "Utiliser les données pour prendre de meilleures décisions",
          duration: "35 min",
          type: "video",
          order: 3
        }
...
export const revenueManagement: Course = {
  ...
  description: "Optimisation des revenus pour établissements touristiques. Apprenez les techniques avancées de revenue management pour maximiser la rentabilité de votre établissement hôtelier ou touristique.",
  ...
  instructor: {
    ...
    expertise: ["Revenue Management", "Pricing Strategy", "Distribution", "Analytics"]
  },
  modules: [
    {
      id: "module-1",
  ...
  tags: ["Revenue Management", "Pricing", "Analytics", "Distribution", "Optimisation"]
};
