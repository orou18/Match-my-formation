...
const translations = {
  fr: {
    ...
    'demo.instruction_theme': 'Cliquez sur l\'icône lune/soleil pour changer le thème',
    'demo.instruction_language': 'Cliquez sur le drapeau pour changer la langue',
    'demo.instruction_persistence': 'Les préférences sont sauvegardées automatiquement',
    'demo.instruction_refresh': 'Rafraîchissez la page pour voir la persistance',
  ...
  es: {
    ...
    'demo.instruction_theme': 'Haga clic en el ícono luna/sol para cambiar el tema',
    'demo.instruction_language': 'Haga clic en la bandera para cambiar el idioma',
    'demo.instruction_persistence': 'Las preferencias se guardan automáticamente',
    'demo.instruction_refresh': 'Actualice la página para ver la persistencia',
    
    // Préférences supplémentaires
    'preferences.notifications_desc': 'Gestione sus preferencias de notificación',
...
export function TranslationProvider({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    if (savedLanguage && ['fr', 'en', 'es'].includes(savedLanguage)) {
      ...
      const defaultLang = ['fr', 'en', 'es'].includes(browserLang) ? browserLang as Language : 'fr';
  ...
  return (
    <TranslationContext.Provider value={{ language, setLanguage, t, changeLanguage }}>
      {children}
